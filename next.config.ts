...
const nextConfig: NextConfig = {
  ...
  webpack: (config, { isServer }) => { // 'isServer' is correctly destructured from the options object
    if (isServer) {
      ...
      config.externals = [
        ...
        // Explicitly type the request as string and callback with its signature
